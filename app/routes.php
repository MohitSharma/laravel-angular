...
Route::get('/post/update/{id}', array('uses' => 'PostController@update', 'as' => 'get.post.single'))->where('id', '[1-9][0-9]*');
Route::get('/post/destroy/{id}', array('uses' => 'PostController@destroy', 'as' => 'get.post.destroy'))->where('id', '[1-9][0-9]*');
